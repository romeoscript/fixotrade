...
<body class="boxed_wrapper ltr">
    ...
    <div id="loader" class="text-center xcon"
        style="position: fixed; left: 0; right: 0; top: 0; bottom: 0; z-index: 9999; width: 100%; height: 100%; background-color: #1c1e2f; opacity: 0; overflow: hidden;">
                            ...
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Investments</a>
                                        <ul>
                                            <li><a href="{{ route('login') }}?p=3">REAL ESTATE</a></li>
                                            <li><a href="{{ route('login') }}?p=5">FOREX</a></li>
                                            <li><a href="{{ route('login') }}?p=6">CRYPTOCURRENCY</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="auto-container">
                <div class="widget-section">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                ...
                                <ul class="info-list clearfix">
                                    <li><i class="fas fa-map-marker-alt"></i>Flat 41 Brookfield Farm, Curzon St,
                                        Lbstock, United Kingddom, LE67 6LA</li>
                                    ...
                                    <li><i class="fas fa-globe"></i>Website  futuresoptimax.com</li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget ml-70">
                                <div class="widget-title">
                                    <h4>{{ $compd ? $compd->companyname : 'company name' }}</h4>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 footer-column">
                        <div class="footer-widget logo-widget">
                            <figure class="footer-logo"><a href="index.php"><img src="images/tfc-icon.png" style="height: 60px; width: auto;" alt=""></a></figure>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 footer-column">
                        <div class="footer-widget links-widget ml-70">
                            ...
                            <div class="text">
                                <p>
                                    {{ $compd ? $compd->companyname : 'company name' }} is a member of The Financial Commission, an international organization engaged in
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 footer-column">
                        <div class="footer-widget logo-widget">
                            <figure class="footer-logo"><a href="index.php"><img src="images/sec-logo.png" style="height: 60px; width: auto;" alt=""></a></figure>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 footer-column">
                        <div class="footer-widget links-widget ml-70">
                            ...
                            <div class="text">
                                <p>
                                    {{ $compd ? $compd->companyname : 'company name' }} is regulated by the US Securities and Exchange Commission. The mission of the SEC is to protect
                     investors; maintain fair,
                     orderly, and efficient markets; and facilitate capital formation.
                     
                     {{ $compd ? $compd->companyname : 'company name' }} is an investment company that . Direct access to over 50 financial markets
                     ...
                     {{ $compd ? $compd->companyname : 'company name' }} is a registered investment dealer, a member of the
                     ...
                     activities undertaken by {{ $compd ? $compd->companyname : 'company name' }}.
                                </p>
                            </div>
